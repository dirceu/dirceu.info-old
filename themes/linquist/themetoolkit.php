...
if (!class_exists('ThemeToolkit')) {
    class ThemeToolkit{
        ...
        function add_menu() {
            ...
            add_theme_page('Options', $this->infos['theme_name'] . ' options', 'edit_themes', basename($this->file), array(&$this,'admin_menu'));
        ...
        function admin_menu () {
            ...
            <table cellspacing="10" cellpadding="5" border="0" width=100% class="editform">';
            ...
            foreach ($this->infos['menu_options'] as $key=>$val) {
                ...
                print "<tr valign='top'><th style='text-align: right' scope='row' width='33%'>\n";
                if (@$items) {
            ...
            echo '</table>
            <p><input type="submit" value="Store Options" /></p>
            </form>';
            ...
            <p><input type="submit" value="Delete Options" onclick="return confirm(\'Are you really sure you want to delete these options from the database?\');"/></p>
            </form>';
            ...
            echo 'This administration menu uses <a href="http://frenchfragfactory.net/ozh/my-projects/wordpress-theme-toolkit-admin-menu/" title="Wordpress Theme Toolkit : create a admin menu for your own theme as easily as editing 3 lines">Wordpress Theme Toolkit</a> by <a href="http://frenchfragfactory.net/ozh/" title="planetOzh">Ozh</a>. The lightbox plugin was made by <a href="http://zeo.unic.net.my/">Safirul Alredha</a>.</p>
            </div>
            <div><div style="float:right;margin-left:-180px;padding-right:5%"><p><a href="http://frenchfragfactory.net/ozh/my-projects/wordpress-theme-toolkit-admin-menu/">Theme Toolkit</a> by<br />
